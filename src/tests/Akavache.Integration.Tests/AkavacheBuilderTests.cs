...
public class AkavacheBuilderTests
{
    ...
    {
        CacheDatabase.Initialize<SystemJsonSerializer>("TestApp_BlobCachesInstanceDict");
        var instance = CacheDatabase.CurrentInstance!;

        await Assert.That(instance.BlobCaches).IsNotNull();
    ...
    {
        CacheDatabase.Initialize<SystemJsonSerializer>("TestApp_SettingsStoresInstanceDict");
        var instance = CacheDatabase.CurrentInstance!;

        await Assert.That(instance.SettingsStores).IsNotNull();
