...
public class DownloadUrlExtensionsTests
{
    ...
    public async Task DownloadUrlShouldHandleInvalidUrls()
    {
        ...
        try
        {
            ...
            var isExpectedType = caughtException is HttpRequestException or SocketException or TaskCanceledException or TimeoutException or UriFormatException or ArgumentException;
    ...
    public async Task DownloadUrlShouldValidateArguments()
    {
        ...
        try
        {
            ...
            var isEmptyUrlExpected = emptyUrlException is ArgumentException or UriFormatException or InvalidOperationException;
            ...
            var isWhitespaceUrlExpected = whitespaceUrlException is ArgumentException or UriFormatException or InvalidOperationException;
