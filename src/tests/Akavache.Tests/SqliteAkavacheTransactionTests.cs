...
public class SqliteAkavacheTransactionTests
{
    ...
    /// <summary>
    /// Yields each <see cref="IAkavacheConnection"/> implementation under test (in-memory,
    /// SQLite, and encrypted SQLite). The caller takes ownership of disposal.
    /// </summary>
    /// <returns>An async sequence of connection instances.</returns>
