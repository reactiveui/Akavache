...
public class SerializationCompatibilityTests
{
    ...
    /// <returns>A task representing the asynchronous test operation.</returns>
    /// <exception cref="InvalidOperationException">Thrown when a supported serializer combination fails to round-trip.</exception>
    [Test]
    ...
    /// <returns>A task representing the test operation.</returns>
    /// <exception cref="InvalidOperationException">Thrown when a supported serializer combination fails to round-trip through SQLite.</exception>
