...
public class EncryptedSqlite3LegacyV11CompatibilityTests
{
    ...
    /// <exception cref="InvalidOperationException">Thrown when <c>sqlite3_step(stmt) != SQLITE_DONE</c>.</exception>
    ...
    /// <exception cref="InvalidOperationException">Thrown when <paramref name="rc"/> is an error code.</exception>
