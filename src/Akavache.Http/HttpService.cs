...
public class HttpService : IHttpService, IDisposable
{
        ...
        TimeSpan? timeout = null)
    {
        ...
        var timedRequest = request.Timeout(timeout ?? TimeSpan.FromSeconds(15), CacheDatabase.TaskpoolScheduler);
        return retries > 0 ? timedRequest.Retry(retries) : timedRequest;
    }

    /// <summary>
    /// Releases the resources used by the <see cref="HttpService"/>.
    /// </summary>
