...
public class CacheDatabaseTests
{
    ...
    {
        var customScheduler = System.Reactive.Concurrency.ImmediateScheduler.Instance;
    ...
    private sealed class ThrowingFlushBlobCache : IBlobCache
    {
        ...
        public IScheduler Scheduler { get; } = System.Reactive.Concurrency.ImmediateScheduler.Instance;
