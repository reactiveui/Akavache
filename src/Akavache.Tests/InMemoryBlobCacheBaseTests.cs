...
public class InMemoryBlobCacheBaseTests
{
    ...
    public async Task InsertKeyValuePairsShouldThrowOnDisposed()
    {
        ...
        await Assert.That(async () => await cache.Insert(new[] { new KeyValuePair<string, byte[]>("k", new byte[] { 1 }) }).ToTask())
    ...
    public async Task InsertSingleShouldThrowOnDisposed()
    {
        ...
        await Assert.That(async () => await cache.Insert("key", new byte[] { 1, 2, 3 }).ToTask())
            .Throws<ObjectDisposedException>();
    }
    ...
    public async Task GetMultipleShouldThrowOnDisposed()
    {
        ...
        await Assert.That(async () => await cache.Get(new[] { "k1", "k2" }).ToList().ToTask())
            .Throws<ObjectDisposedException>();
    }
    ...
    public async Task InvalidateMultipleShouldThrowOnDisposed()
    {
        ...
        await Assert.That(async () => await cache.Invalidate(new[] { "k1", "k2" }).ToTask())
            .Throws<ObjectDisposedException>();
    }
    ...
    public async Task UpdateExpirationKeysShouldErrorOnDisposed()
    {
        ...
        await Assert.That(async () => await cache.UpdateExpiration(new[] { "k1" }, DateTimeOffset.Now).ToTask())
            .Throws<ObjectDisposedException>();
    }
    ...
    public async Task UpdateExpirationKeysTypeShouldErrorOnNullType()
    {
        ...
        try
        {
            await Assert.That(async () => await cache.UpdateExpiration(new[] { "k1" }, null!, DateTimeOffset.Now).ToTask())
                .Throws<ArgumentNullException>();
        }
        finally
        {
    ...
    public async Task UpdateExpirationKeysTypeShouldErrorOnDisposed()
    {
        ...
        await Assert.That(async () => await cache.UpdateExpiration(new[] { "k1" }, typeof(string), DateTimeOffset.Now).ToTask())
            .Throws<ObjectDisposedException>();
    }
    ...
    public async Task UpdateExpirationShouldUpdateExistingEntry()
    {
        ...
        try
        {
            await cache.Insert("key1", new byte[] { 1, 2, 3 }).ToTask();
    ...
    public async Task UpdateExpirationKeysShouldUpdateMultiple()
    {
        ...
        try
        {
            ...
            await cache.UpdateExpiration(new[] { "k1", "k2" }, DateTimeOffset.Now.AddHours(1)).ToTask();
    ...
    public async Task VacuumShouldRemoveExpiredEntries()
    {
        ...
        try
        {
            ...
            await cache.Insert("expired", new byte[] { 1 }, DateTimeOffset.Now.AddSeconds(-10)).ToTask();
            await cache.Insert("valid", new byte[] { 2 }, DateTimeOffset.Now.AddHours(1)).ToTask();
    ...
    public async Task InsertKeyValuePairsWithTypeShouldThrowOnDisposed()
    {
        ...
        await Assert.That(async () => await cache.Insert(new[] { new KeyValuePair<string, byte[]>("k", [1]) }, typeof(UserObject)).ToTask())
            .Throws<ObjectDisposedException>();
    }
    ...
    public async Task GetMultipleWithTypeShouldReturnValues()
    {
        ...
        try
        {
            ...
            var results = await cache.Get(new[] { "k1", "k2", "missing" }, typeof(UserObject)).ToList().ToTask();
    ...
    public async Task GetCreatedAtKeysShouldReturnTimestampsAndNulls()
    {
        ...
        try
        {
            ...
            var results = await cache.GetCreatedAt(new[] { "k1", "missing" }).ToList().ToTask();
            await Assert.That(results.Count).IsEqualTo(2);
    ...
    public async Task GetCreatedAtKeysShouldThrowOnDisposed()
    {
        ...
        await Assert.That(async () => await cache.GetCreatedAt(new[] { "k" }).ToList().ToTask())
            .Throws<ObjectDisposedException>();
    }
    ...
    public async Task GetCreatedAtKeysWithTypeShouldReturnTimestamps()
    {
        ...
        {
            await cache.Insert("k1", [1], typeof(UserObject)).ToTask();
            var results = await cache.GetCreatedAt(new[] { "k1" }, typeof(UserObject)).ToList().ToTask();
    ...
    public async Task InvalidateMultipleWithTypeShouldRemoveEntries()
    {
        ...
        try
        {
            ...
            await cache.Invalidate(new[] { "k1", "k2" }, typeof(UserObject)).ToTask();
    ...
    public async Task UpdateExpirationKeysWithTypeShouldUpdateMatching()
    {
        ...
        try
        {
            ...
            await cache.UpdateExpiration(new[] { "k1", "k2" }, typeof(UserObject), DateTimeOffset.Now.AddHours(1)).ToTask();
    ...
    public async Task ForcedDateTimeKindSetterShouldPropagateToRegisteredAppLocatorSerializer()
    {
        ...
        Splat.AppLocator.CurrentMutable.RegisterConstant(registered, typeof(ISerializer));
        ...
        var resolved = Splat.AppLocator.Current.GetService<ISerializer>();
    ...
    public async Task UpdateExpirationKeysWithTypeShouldIgnoreMismatchedType()
    {
        ...
        try
        {
            ...
            await cache.UpdateExpiration(new[] { "k" }, typeof(string), DateTimeOffset.Now.AddHours(1)).ToTask();
    ...
    public async Task UpdateExpirationKeysShouldNoopWhenKeysMissing()
    {
        ...
        try
        {
            await cache.UpdateExpiration(new[] { "missing1", "missing2" }, DateTimeOffset.Now.AddHours(1)).ToTask();
        }
        finally
        {
            await cache.DisposeAsync();
    ...
    public async Task UpdateExpirationKeysWithTypeShouldNoopWhenKeysMissing()
    {
        ...
        try
        {
            await cache.UpdateExpiration(new[] { "missing" }, typeof(UserObject), DateTimeOffset.Now.AddHours(1)).ToTask();
        }
        finally
        {
            await cache.DisposeAsync();
