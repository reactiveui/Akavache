...
public class UniversalSerializerTests
{
    ...
    /// <returns>A task.</returns>
    [Test]
    public async Task TryDeserializeBsonFormatShouldHandleDateTimeWithUtcKind()
    {
        RegisterAllSerializers();
        try
        {
    ...
    /// <returns>A task.</returns>
    [Test]
    public async Task TryDeserializeBsonFormatShouldHandleDateTimeWithLocalKind()
    {
        RegisterAllSerializers();
        try
        {
    ...
    /// <returns>A task.</returns>
    [Test]
    public async Task TryDeserializeBsonFormatShouldHandleDateTimeWithUnspecifiedKind()
    {
        RegisterAllSerializers();
        try
        {
    ...
    {
        var result = UniversalSerializer.TryDeserializeBsonFormat<UserObject>(new byte[] { 0xFF, 0xFE, 0x00, 0x01, 0x02 }, null);
        await Assert.That(result).IsNull();
    }
