...
public sealed class InMemoryBlobCache(IScheduler scheduler) : IBlobCache, ISecureBlobCache, IEnableLogger
{
    ...
    /// The serializer.
    /// </value>
    public ISerializer Serializer { get; } = CreateAndRegisterSystemTextJsonSerializer();
    ...
    /// <summary>
    /// Insert an object into the cache using System.Text.Json serialization.
    /// </summary>
    ...
    /// <summary>
    /// Get an object from the cache and deserialize it using System.Text.Json serialization.
    /// </summary>
...
#if NET8_0_OR_GREATER
    [RequiresUnreferencedCode("GetOrFetchObject for ReactiveMarbles.CacheDatabase.SystemTextJson")]
    [RequiresDynamicCode("GetOrFetchObject for ReactiveMarbles.CacheDatabase.SystemTextJson")]
#endif
