# ReactiveMarbles.CacheDatabase.Drawing

Drawing and bitmap support for ReactiveMarbles.CacheDatabase using Splat.Drawing.

## Overview

This package provides image caching and bitmap manipulation functionality for ReactiveMarbles.CacheDatabase, offering feature parity with Akavache.Drawing plus additional enhancements.
...
ReactiveMarbles.CacheDatabase.Drawing provides direct compatibility:
...
// New ReactiveMarbles.CacheDatabase.Drawing code (same API):
...
- `ReactiveMarbles.CacheDatabase.Core` - Core caching functionality
