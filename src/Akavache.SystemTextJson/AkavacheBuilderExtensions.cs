...
public static class AkavacheBuilderExtensions
{
    ...
    {
        /// <summary>Configures the builder to use System.Text.Json serialization with default options.</summary>
        /// <returns>The builder instance for fluent configuration.</returns>
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="builder"/> is null.</exception>
        public IAkavacheBuilder WithSerializerSystemTextJson()
        {
        ...
        /// <summary>Configures the builder to use System.Text.Json serialization with custom options.</summary>
        ...
        public IAkavacheBuilder WithSerializerSystemTextJson(JsonSerializerOptions settings)
        {
            ArgumentExceptionHelper.ThrowIfNull(builder);
            ArgumentExceptionHelper.ThrowIfNull(settings);

            _ = builder.WithSerializer(() => new SystemJsonSerializer { Options = settings });
            UniversalSerializer.RegisterSerializer(() => new SystemJsonSerializer { Options = settings });
            return builder;
        }

        /// <summary>Configures the builder to use System.Text.Json serialization with options configured through a delegate.</summary>
        ...
        public IAkavacheBuilder UseSystemTextJsonSerializer(Action<JsonSerializerOptions> configure)
        {
            ArgumentExceptionHelper.ThrowIfNull(builder);
