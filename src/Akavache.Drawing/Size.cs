...
public readonly struct Size(float width, float height) : IEquatable<Size>
{
    ...
    /// <summary>Gets the height dimension in pixels.</summary>
    public float Height { get; } = height;

    /// <summary>Gets the aspect ratio calculated as width divided by height.</summary>
    public float AspectRatio => Height != 0 ? Width / Height : 0;

    /// <summary>Determines whether two <see cref="Size"/> instances are equal.</summary>
