...
public class AppSettings
{
    ...
    /// <summary>
    /// Gets or sets the window width for persistence.
    /// </summary>
    [JsonPropertyName("windowWidth")]
    public double WindowWidth { get; set; } = 900;

    /// <summary>
    /// Gets or sets the window height for persistence.
    /// </summary>
    [JsonPropertyName("windowHeight")]
    public double WindowHeight { get; set; } = 600;

    /// <summary>
    /// Gets or sets the window left position for persistence.
    /// </summary>
    [JsonPropertyName("windowLeft")]
    public double WindowLeft { get; set; } = 100;

    /// <summary>
    /// Gets or sets the window top position for persistence.
    /// </summary>
