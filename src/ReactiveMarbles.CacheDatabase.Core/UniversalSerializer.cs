...
public static class UniversalSerializer
{
    ...
    private static List<ISerializer> GetAvailableAlternativeSerializers(ISerializer excludeSerializer)
    {
        ...
        var knownSerializerTypes = new[]
        {
            ...
            "ReactiveMarbles.CacheDatabase.SystemTextJson.SystemJsonBsonSerializer",
            "ReactiveMarbles.CacheDatabase.NewtonsoftJson.NewtonsoftSerializer",
            "ReactiveMarbles.CacheDatabase.NewtonsoftJson.NewtonsoftBsonSerializer"
        };
