...
/// <summary>
/// Tests for the <see cref="SystemTextJson.Bson.InMemoryBlobCache"/> class with BSON serialization for object bulk operations.
/// </summary>
public class SystemTextJsonBsonInMemoryBlobCacheObjectBulkOperationsTests : ObjectBulkOperationsTestBase
{
    /// <inheritdoc/>
