...
/// <summary>
/// Tests for the <see cref="SystemTextJson.Bson.InMemoryBlobCache"/> class with BSON serialization.
/// </summary>
public class SystemTextJsonBsonInMemoryBlobCacheBulkOperationsTests : BulkOperationsTestBase
{
    /// <inheritdoc/>
