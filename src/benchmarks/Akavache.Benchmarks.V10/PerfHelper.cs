...
/// <summary> Helper utilities for V10 benchmark fixtures — generates random keys and payloads to populate a cache before measuring read/write throughput. </summary>
