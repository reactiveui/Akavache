...
{
    /// <summary>
    /// IBlobCache is the core interface on which Akavache is built, it is an interface describing an
    ...
    {
        /// <summary>
        /// Inserts several keys into the database at one time. If any individual insert fails, this
        /// operation should cancel the entire insert (i.e. it should *not* partially succeed)
        /// </summary>
        ...
        /// <summary>
        /// Retrieve several values from the key-value cache. If any of the keys are not in the
        /// cache, this method should return an IObservable which OnError's with KeyNotFoundException.
        /// </summary>
        ...
        /// <summary>
        /// Returns the time that the keys were added to the cache, or returns null if the key isn't
        /// in the cache.
        /// </summary>
        ...
        /// <summary>
        /// Remove several keys from the cache. If the key doesn't exist, this method should do
        /// nothing and return (*not* throw KeyNotFoundException).
        /// </summary>
        /// <param name="keys">The keys.</param>
        /// <returns></returns>
    ...
    /// <summary>
    /// This interface indicates that the underlying BlobCache implementation encrypts or otherwise
    /// secures its persisted content. /// By implementing this interface, you must guarantee that
    /// the data saved to disk cannot be easily read by a third party.
    /// </summary>
    public interface ISecureBlobCache : IBlobCache { }

    /// <summary>
    /// This interface indicates that the underlying BlobCache implementation can handle objects.
    /// </summary>
    ...
    public interface IObjectBulkBlobCache : IObjectBlobCache, IBulkBlobCache
    {
        ...
        /// <summary>
        /// Invalidates several objects from the cache. It is important that the Type Parameter for
        /// this method be correct, and you cannot use IBlobCache.Invalidate to perform the same task.
        /// </summary>
