...
public interface IBlobCache : IDisposable
{
    ...
    /// <summary>Gets a observable of key value pairs with the specified keys with their corresponding values.</summary>
    ...
    /// <summary>Gets a observable of key value pairs with the specified keys with their corresponding created <see cref="DateTimeOffset"/> if it's available.</summary>
    /// <param name="keys">The keys to get the values for.</param>
    /// <returns>A observable with the specified values.</returns>
    IObservable<(string Key, DateTimeOffset? Time)> GetCreatedAt(IEnumerable<string> keys);

    /// <summary>Returns the time that the key was added to the cache, or returns null if the key isn't in the cache.</summary>
    ...
    {
        /// <summary>Throws an key not found exception in an observable.</summary>
        ...
        public static IObservable<T> ObservableThrowKeyNotFoundException<T>(string key) =>
            ObservableThrowKeyNotFoundException<T>(key, (Exception?)null);
        ...
        public static IObservable<T> ObservableThrowObjectDisposedException<T>(string obj) =>
            ObservableThrowObjectDisposedException<T>(obj, (Exception?)null);
