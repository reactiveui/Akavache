...
namespace Akavache
{
    ...
    {
        /// <summary>
        /// Download data from an HTTP URL and insert the result into the cache. If the data is
        /// already in the cache, this returns a cached value. The URL itself is used as the key.
        /// </summary>
        ...
        /// <summary>
        /// Download data from an HTTP URL and insert the result into the cache. If the data is
        /// already in the cache, this returns a cached value. An explicit key is provided rather
        /// than the URL itself.
        /// </summary>
        /// <param name="This">The this.</param>
            ...
            TimeSpan? timeout = null)
        {
...
#endif
            {
                request = Observable.Defer(() => {
                    ...
                    // NB: You'd think that BeginGetResponse would never block, seeing as how it's
                    // asynchronous. You'd be wrong :-/
