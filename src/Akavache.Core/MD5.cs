...
internal sealed class MD5Core
{
    ...
    public static byte[] GetHash(string input) => GetHash(input, new UTF8Encoding());
    ...
    public static string GetHashString(string input) => GetHashString(input, new UTF8Encoding());
    ...
    */
    ...
    static uint[] Converter(IReadOnlyList<byte> input, int ibStart)
    {
        if (null == input)
