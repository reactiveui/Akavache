...
{
    /// <summary>Gets the executing assembly.</summary>
    /// <remarks>
    ...
    [SuppressMessage(
        ...
        Justification = "Retained deliberately for one release so consumers can migrate via the documented path.")]
    Assembly ExecutingAssembly { get; }

    /// <summary>Gets the application name used for cache directory paths.</summary>
    string ApplicationName { get; }

    /// <summary>Gets the application root path.</summary>
    string? ApplicationRootPath { get; }

    /// <summary>Gets or sets the settings cache path.</summary>
    string? SettingsCachePath { get; set; }

    /// <summary>Gets the short name of the executing assembly.</summary>
    /// <remarks>
    ...
    /// <summary>Gets the parsed <see cref="AssemblyFileVersionAttribute"/> of the executing assembly.</summary>
    /// <remarks>
    /// <see langword="null"/> unless the caller has set an explicit assembly via
    /// <c>WithExecutingAssembly</c> on the builder.
    /// </remarks>
    ...
    /// <summary>Gets the InMemory cache instance for temporary data storage.</summary>
    IBlobCache? InMemory { get; }

    /// <summary>Gets the LocalMachine cache instance for persistent but temporary data.</summary>
    IBlobCache? LocalMachine { get; }

    /// <summary>Gets the Secure cache instance for encrypted data storage.</summary>
    ISecureBlobCache? Secure { get; }

    /// <summary>Gets the UserAccount cache instance for user-specific persistent data.</summary>
    IBlobCache? UserAccount { get; }

    /// <summary>Gets the serializer used for object serialization and deserialization.</summary>
