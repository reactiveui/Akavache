...
public interface IAkavacheBuilder : IAkavacheInstance
{
    ...
    /// <summary>Sets the application name for cache directory paths.</summary>
    ...
    /// <summary>Sets the LocalMachine cache instance.</summary>
    ...
    /// <summary>Sets the Secure cache instance.</summary>
    ...
    /// <summary>Sets the UserAccount cache instance.</summary>
    ...
    /// <summary>Configures the serializer to use for cache operations.</summary>
    ...
    [SuppressMessage(
        ...
        Justification = "T is the serializer the caller selects; implementations construct it via the new() constraint.")]
    IAkavacheBuilder WithSerializer<T>()
        where T : class, ISerializer, new();

    /// <summary>Configures the serializer to use for cache operations with a custom factory function.</summary>
    /// <typeparam name="T">The type of serializer to configure.</typeparam>
    ...
    /// <summary>Sets the forced DateTime kind for serialization operations.</summary>
    ...
    /// <summary>Builds the configuration and returns the configured Akavache instance.</summary>
