...
/// <summary>Configuration options for migrating data from Akavache V10 databases to V11.</summary>
...
/// <param name="ReserializeToCurrentFormat">
/// Whether to re-serialize cached values from the V10 format (typically BSON) to the current
/// serializer format (for example System.Text.Json for AOT compatibility). When
/// <see langword="false"/> the original bytes are preserved and the UniversalSerializer handles
/// format detection at read time. Default <see langword="true"/>.
/// </param>
...
[System.Diagnostics.DebuggerDisplay("V10MigrationOptions: {ToString(),nq}")]
